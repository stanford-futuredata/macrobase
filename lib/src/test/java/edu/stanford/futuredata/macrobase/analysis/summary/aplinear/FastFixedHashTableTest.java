...
public class FastFixedHashTableTest {
    ...
    public void testSimple() {
        ...
        assertEquals(1.0, table.get(1)[1], 0.01);
        assertEquals(2.0, table.get(2)[1], 0.01);
        assertEquals(3.0, table.get(3)[1], 0.01);
        assertEquals(4.0, table.get(18)[1], 0.01);
        assertEquals(5.0, table.get(4)[1], 0.01);
        assertEquals(6.0, table.get(19)[1], 0.01);
