...
public class CountMeanShiftCubedClassifierTest {
    ...
    public void testClassify() throws Exception {
        ...
        double[] outlierCountColumn = output.getDoubleColumnByName(pc.outlierCountColumnName);
        double[] inlierMeanColumn = output.getDoubleColumnByName(pc.inlierMeanColumnName);
