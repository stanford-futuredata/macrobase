...
public class Explain
  ...
  public Explain(Statement statement, boolean analyze, boolean verbose,
      List<ExplainOption> options) {
    this(Optional.empty(), analyze, verbose, statement, options);
  }

  public Explain(NodeLocation location, boolean analyze, boolean verbose, Statement statement,
      List<ExplainOption> options) {
    this(Optional.of(location), analyze, verbose, statement, options);
  }

  private Explain(Optional<NodeLocation> location, boolean analyze, boolean verbose,
      Statement statement, List<ExplainOption> options) {
    super(location);
