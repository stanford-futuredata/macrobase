...
def parse_args():
  ...
  run_parser.set_defaults(func=run_train_test_accuracy)
...
def _run(workload, _dir):
  ...
  with open(config_filename, 'w') as outfile:
    ...
    run_macrobase(conf=config_filename, save_log=log_filename)
...
def run_train_test_accuracy(args):
