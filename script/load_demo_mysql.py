...
cur.execute("DROP TABLE IF EXISTS sensor_data_demo; CREATE TABLE sensor_data_demo ( reading_id bigint NOT NULL, device_id bigint NOT NULL, state varchar(2), model varchar(40), firmware_version varchar(40), temperature double, power_drain double );")
